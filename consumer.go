...
// Adapted from example found in https://github.com/streadway/amqp/issues/133
...
// wait 10 seconds before trying to reconnect. Any shorter amount of time
...
func (c *Consumer) ReConnect(queueName, bindingKey string) (<-chan amqp.Delivery, error) {
	log.Printf("Sleeping for 10 sec before attempting to reconnect to RabbitMQ")
...
// should be a delievey channel as created when you call AnnounceQueue
...
// become unreachable unless put in a goroutine. The q and rk params
